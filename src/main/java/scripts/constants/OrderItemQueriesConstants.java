...
public class OrderItemQueriesConstants {
    ...
    public static final String INSERT_QUERY = "INSERT INTO "+TABLE_NAME+"\n" +
            ...
            "VALUES(?, ?, ?, ?)";
    public static final String FIND_BY_ID_QUERY = "select * from "+TABLE_NAME+" WHERE order_id=? AND product_id=?";

    public static final String FIND_ALL_QUERY = "select * from " + TABLE_NAME;
    public static final String DELETE_QUERY = "delete from " + TABLE_NAME + " WHERE order_id=? AND product_id=?";
